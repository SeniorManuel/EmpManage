...
public class Gui extends JFrame {
    ...
    public Gui() {
        ...
        addP(panDetails, type, 0, 2, 1, 1);
        addP(panDetails, ttype, 1, 2, 1, 1);
        addP(panDetails, dwork, 2, 2, 1, 1);
        addP(panDetails, tdwork, 3, 2, 1, 1);
        add(panDetails, 0, 0, 4, 1);
